...
public class HelixURI {
    ...
    /**
     * Constructs a new HelixURI from the given string. Can be for any network.
     *
     ...
     */
    public HelixURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public HelixURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("HelixURI[");
        boolean first = true;
