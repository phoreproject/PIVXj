 ...
 * the lightweight SPV mode, a {@link org.helixj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.helixj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
